...
case $choice in
    1)
        echo "🚀 启动完整版混沌测试..."
        python3 /home/liuyoushan/ape-demo/perf/chaos/chaos_engine.py
        ;;
    2)
        echo "🚀 启动简化版混沌测试..."
        python3 /home/liuyoushan/ape-demo/perf/chaos/chaos_simple.py
        ;;
    *)
        echo "❌ 无效选择"
        exit 1
...
echo "          混沌测试完成！"
echo "=============================================="
echo "报告位置: /home/liuyoushan/ape-demo/perf/chaos/reports/"
